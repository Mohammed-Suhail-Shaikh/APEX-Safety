...
export function Hero() {
  return (
    <section className="relative flex min-h-[87svh] items-end overflow-hidden pt-14 sm:min-h-[100svh] sm:pt-16">
      ...
      <div className="page-shell relative z-10 w-full pb-8 pt-10 sm:pb-20 sm:pt-24 lg:pb-28 lg:pt-32">
        <p className="mb-2 font-heading text-[10px] font-semibold tracking-[0.12em] text-green-muted uppercase sm:mb-5 sm:text-sm sm:tracking-[0.08em]">
        ...
        <div className="flex w-full flex-col gap-2.5 sm:w-auto sm:flex-row sm:flex-wrap sm:gap-4">
          <a
            href="#contact"
            className="inline-flex min-h-11 items-center justify-center bg-green-cta px-5 py-3 text-center font-heading text-[13px] font-bold tracking-wide text-white transition-opacity hover:opacity-90 sm:min-h-0 sm:px-7 sm:py-3.5 sm:text-sm"
          >
            Get a Free Consultation
          </a>
          <a
            href="#services"
            className="inline-flex min-h-11 items-center justify-center border border-white/35 px-5 py-3 text-center font-heading text-[13px] font-bold tracking-wide text-white/90 transition-colors hover:border-white/75 hover:text-white sm:min-h-0 sm:px-7 sm:py-3.5 sm:text-sm"
          >
            View Services
          </a>
        </div>
